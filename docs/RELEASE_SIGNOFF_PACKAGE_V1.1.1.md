...
| 角色 | 职责确认 | 签字 | 日期 |
|---|---|---|---|
| Owner（canqu） | 范围、变更清单与证据链确认 | canqu | 2026-08-14 |
| 发布负责人 | CI/Release/演练证据复核 | canqu | 2026-08-14 |
| QA | 测试与合同证据复核 | canqu | 2026-08-14 |

> 单人交付模式下以上角色均由 owner 承担，签署即视为全部角色确认。

> 签署留痕：`Owner` 由 canqu 于 2026-08-14 签署；签署时 master HEAD = `7405f09`（Release v1.1.1 指向 792751e）。

> 签署留痕：`发布负责人` 由 canqu 于 2026-08-14 签署；签署时 master HEAD = `7405f09`（Release v1.1.1 指向 792751e）。

> 签署留痕：`QA` 由 canqu 于 2026-08-14 签署；签署时 master HEAD = `7405f09`（Release v1.1.1 指向 792751e）。
